...
<head>
  ...
  <title>Exercícios de Word - Prof. Alecx</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <div class="container mt-5">
    <div class="jumbotron">
      <h1 class="display-4"><i class="fas fa-globe"></i> Exercícios de Word</h1>
      <p class="lead">Pratique seus conhecimentos sobre o Microsoft Word com estes exercícios básicos.</p>
    </div>

    <form id="exercise-form">
      <div class="exercise">
        <h2>Exercício 1</h2>
        <p>O que é o Microsoft Word?</p>
        <ol>
          <li><input type="radio" name="question1" value="a"> Um programa de edição de fotos</li>
          <li><input type="radio" name="question1" value="b"> Um programa para fazer apresentações</li>
          <li><input type="radio" name="question1" value="c"> Um programa de processamento de texto</li>
        </ol>
      </div>

      <div class="exercise">
        <h2>Exercício 2</h2>
        <p>Qual é a extensão padrão dos arquivos do Microsoft Word?</p>
        <ol>
          <li><input type="radio" name="question2" value="a"> .pdf</li>
          <li><input type="radio" name="question2" value="b"> .docx</li>
          <li><input type="radio" name="question2" value="c"> .txt</li>
        </ol>
      </div>

      <div class="exercise">
        <h2>Exercício 3</h2>
        <p>Qual é a função do botão "Salvar" no Microsoft Word?</p>
        <ol>
          <li><input type="radio" name="question3" value="a"> Enviar o documento por e-mail</li>
          <li><input type="radio" name="question3" value="b"> Fechar o documento sem salvar</li>
          <li><input type="radio" name="question3" value="c"> Salvar as alterações feitas no documento</li>
        </ol>
      </div>

      <div class="exercise">
        <h2>Exercício 4</h2>
        <p>Qual é a função do botão "Copiar" no Microsoft Word?</p>
        <ol>
          <li><input type="radio" name="question4" value="a"> Apagar o conteúdo selecionado</li>
          <li><input type="radio" name="question4" value="b"> Mover o conteúdo selecionado para outro local</li>
          <li><input type="radio" name="question4" value="c"> Criar uma cópia do conteúdo selecionado</li>
        </ol>
      </div>

      <div class="exercise">
        <h2>Exercício 5</h2>
        <p>Qual é a função do botão "Colar" no Microsoft Word?</p>
        <ol>
          <li><input type="radio" name="question5" value="a"> Recortar o conteúdo selecionado</li>
          <li><input type="radio" name="question5" value="b"> Adicionar uma nova página ao documento</li>
          <li><input type="radio" name="question5" value="c"> Inserir o conteúdo copiado ou cortado no local de destino</li>
        </ol>
      </div>
